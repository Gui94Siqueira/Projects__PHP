...
<body>
    ...
    <section>
        ...
        <ul>
            <li>A <strong>Média Aritmética simples</strong> entre os valores é igual á: <?=number_format($ma,2,",",".")?>.</li>
            <li>A <strong>Média Aritmética Ponderada</strong> com os pesos <?=$peso1?> e o <?=$peso2?> é igual á:<?=number_format($mp,2,",",".")?>.</li>
        </ul>
